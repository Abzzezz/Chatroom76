...
public class DialogLoader implements Basic {

    public static final DialogLoader DIALOG_LOADER = new DialogLoader();

    private final File dialogsFile, dialogDir;
    private final List<Dialog> dialogs = new ArrayList<>();

    public DialogLoader() {
        this.dialogDir = new File(workingDirectory, "game");
        this.dialogsFile = new File(workingDirectory, "dialogs");
