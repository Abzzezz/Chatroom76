...
package net.bplaced.abzzezz.engine.utils.animation;

import net.bplaced.abzzezz.engine.utils.data.ClassUtil;
import net.bplaced.abzzezz.engine.utils.math.MathUtil;
